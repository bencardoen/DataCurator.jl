...
#vcreate_sysimage(sysimage_path="sys_img.so", include_transitive_dependencies=false, precompile_statements_file="dc_precompile.jl"
# cpu_target="generic", incremental=false
# but let's build on remote
